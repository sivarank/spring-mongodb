...
public class BookControllerWithNewRelic {
	


	public static void testNewRelic() {
		   String apiKey = "96697b77d3605718bd3ab9295e12b090f133NRAL";
		    ...
		    io.opentelemetry.api.trace.Tracer tracer = OpenTelemetry.getGlobalTracerProvider().get("sample-app", "1.0");
		    // A Meter is used to create different instruments to record metrics.
		    io.opentelemetry.api.metrics.Meter meter = OpenTelemetry.getGlobalMeterProvider().get("sample-app", "1.0");

		    // Use the meter to create a LongCounter instrument to record metrics.
		    io.opentelemetry.api.metrics.LongCounter spanCounter =
		        meter
